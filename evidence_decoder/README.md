...
측정된 결과 (텍스트, n=1, 2026-08-04)

**근거 희석 억제 - 1층의 기여**

| 무관 근거 비율 | raw 근거정밀 | 1층 있음 | raw 인용정밀 | 1층 있음 |
|---|---|---|---|---|
| 0% | 1.00 | 1.00 | 1.00 | 1.00 |
| 40% | 0.60 | **1.00** | 1.00 | 1.00 |
| 57% | 0.43 | **1.00** | 0.60 | **1.00** |
| 66% | 0.33 | **1.00** | 0.75 | **1.00** |
...
| 결론 | 신뢰도 | 근거 |
|---|---|---|
| 근거 희석 억제는 1층의 기여 | 높음 | raw 0.33 vs 1층 1.00, 효과 크기가 압도적 |
| 충돌 탐지는 2층의 기여 | 높음 | 0.00 vs 1.00, 이분법적 |
| 간결 모드가 품질을 해치지 않음 | 중간 | n=10, 차이 없음 방향 |
| 중복 제거 프롬프트 개선 | 중간 | 0.00 -> 0.50, n=15 |
